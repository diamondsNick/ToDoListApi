...
namespace ToDoListApi.Controllers.V1
{
    ...
    public class StatusesController : BaseController<Status, StatusDTO, long>
    {
        StatusesController(ToDoDbContext context, DbSet<Status> dbSet, IMapper mapper) : base(context, dbSet, mapper) 
        {
